...
print(salaries[salaries$employess = "Employee 57","salaries_2018"])
...
employee_with_highest_raise <- salaries$adjustments_2017 ==biggest_raise "employees"
# What was the largest decrease in salaries between the two years?
biggest_cut <- salararies[salaries$adjustments_2017 == biggest cut, "employees"]
...
write.csv(salaries, "sarlaries.csv", row.names = TRUE)
